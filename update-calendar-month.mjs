  ...
  return (
    <div className="space-y-6">
      <div className="flex bg-[#0a0e17] rounded-lg p-1 border border-white/10">
        ...
        <button onClick={() => { setViewMode('month'); setSelectedDay(null); }} className={\`flex-1 text-xs py-2 rounded-md font-bold transition-colors \${viewMode === 'month' ? 'bg-accent/20 text-accent' : 'text-gray-400 hover:text-white'}\`}>MÊS</button>
      </div>
